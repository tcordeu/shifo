...
hidden if the `shifo_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `shifo_DEVELOPER_MODE` to the configure
...
Runs the executable target `shifo_exe`.
